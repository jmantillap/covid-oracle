...
class SaveFormularioRequest extends FormRequest
{
    ...
    public function messages(){
        ...
        return [
            ...
            't_contactopersonasinfectadas.required' => "No has Respondido acerca de la cercanía con personas infectadas (Preg. 13)",
            't_realizoviaje.required'=>'Realizó Viaje no ha sido respondido (Preg. 15)'
