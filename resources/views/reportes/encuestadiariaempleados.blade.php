...
@section('titulopag','ENCUESTA DIARIA EMPLEADOS UPB')
...
<div class="col-md-4">
  ...
  <script>   
      $(function () {   
        ...
        $("#menuReporteDiariaEmpleados" ).addClass("active" );   
        
        $('#btnConsultar').on('click', function(e) {                         
                $('form[name=search-form]').attr('action','{!! route('reporte.generarExcelDiariaEmpleado.generar.excel'); !!}');
